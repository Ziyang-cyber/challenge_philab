...
def model_prediction(model, input_dir, device):
    ...
    for img in input:
        ...
        with torch.no_grad():
            ...
            saved_dir = '/home/zhangz65/NASA_model/satlas/Adamw_focal_1e-4_f1_12bands_100_0_aug_affine_data_pre_new_sentinel2/pred/'
...
if __name__ == "__main__":
    ...
    print(model)
    model = load_model(model, '/home/zhangz65/NASA_model/satlas/Adamw_focal_1e-4_f1_12bands_100_0_aug_affine_data_pre_new_sentinel2/checkpoint/ckpt_best_f1.pth')
    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
